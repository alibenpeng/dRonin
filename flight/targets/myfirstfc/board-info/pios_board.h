 ...
 * @{
 *
 * @file       STM32F4xx_MyFirstFC.c 
 * @author     Tau Labs, http://taulabs.org, Copyright (C) 2012-2013
 * @author     dRonin, http://dronin.org Copyright (C) 2015
 * @brief      Board specific defines for MyFirstFC
...
#define PIOS_I2C_ETASV3_ADAPTER			(pios_i2c_internal_adapter_id) //this is dirty and should be removed in favor a cleaner sensor api
...
// GPIO
//-------------------------
// [0]: Output-> MyFirstFC Buzzer Pin, with active driver connected to GND
// [1]: Output-> MyFirstFC Battery Pin, take care of the voltage divider connected to this pin
// [2]-[9]: Input-> MyFirstFC PWN IN Pins 1-8, take care of the RcvrPort configuration in GCS and that the Pins are configured with a PullUp Resistor
